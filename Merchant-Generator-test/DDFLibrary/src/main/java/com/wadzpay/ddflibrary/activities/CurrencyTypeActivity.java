...
public class CurrencyTypeActivity extends AppCompatActivity implements View.OnClickListener, ActivityCallBack {
    private String TAG = getClass().getSimpleName();
    public static CurrencyTypeActivity currencyTypeActivity;
...
//        ConstantsActivity.STR_CURRENCY_CODE = ConstantsApi.alDigitalCurrenciesNew.get(positionRadio).get(ConstantsApi.KEYS_FIAT_PARSE[0]) + "";
        ...
        ConstantsActivity.STR_CURRENCY_CODE = ConstantsApi.alDigitalCurrenciesNew.get(positionRadio).get("asset_new"+positionRadio) + "";
