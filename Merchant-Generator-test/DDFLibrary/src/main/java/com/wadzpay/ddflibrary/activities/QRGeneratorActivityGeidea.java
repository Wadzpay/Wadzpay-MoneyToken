...
public class QRGeneratorActivityGeidea extends AppCompatActivity implements ActivityCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            tvTimerQR.setVisibility(View.GONE);
...
//                finish();
//                reverseTimer(ConstantsActivity.INT_QR_TIMER, tvTimerQR);
                apiRetroFitPaymentInfo.getTransactionStatusAlgo(QRGeneratorActivityGeidea.this);
            }
        });
...
//                apiRetroFitPaymentInfo.paymentInfoRetrofit(QRGeneratorActivity.this);
                apiRetroFitPaymentInfo.refreshPaymentInfoRetrofit(QRGeneratorActivityGeidea.this);
            }
        });
        ...
        tvAddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setClipboardEG(QRGeneratorActivityGeidea.this, tvAddress.getText().toString());
            }
        });
...
//                apiRetroFitPaymentInfo.refreshPaymentInfoRetrofit(QRGeneratorActivity.this);
        ...
        rl_qr_format_req_pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialogCustomize.displayArrayDialog(QRGeneratorActivityGeidea.this, ConstantsActivity.STR_FLAG_CHOICE_QR_FORMAT_DIALOG);
            }
        });
...
//        toastCustomize.displayToast(this, strInputText);
    ...
    private void setClipboardEG(Context context, String text) {
        ...
        ToastCustomize toastCustomize = ToastCustomize.getInstance();
        toastCustomize.displayToast(QRGeneratorActivityGeidea.this, "Copied To Clipboard");
    }
